...
body{
	background: #82631e url('wp-content/themes/jq/library/images/BG.jpg') repeat-y; 
...
h2, h3{
	font: 15px 'Franklin Gothic Book', 'Trebuchet MS', Tahoma, Arial;
...
p{
	font: 12.5px 'Franklin Gothic Book', 'Trebuchet MS', Tahoma, Arial;
	color: white;
	}
...
#logo{
	height: 160px;
	background: url('wp-content/themes/jq/library/images/logo.png') no-repeat;
	width: 320px;
	margin: 0 auto;
	}
