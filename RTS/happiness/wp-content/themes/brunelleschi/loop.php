...
<?php endif; ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', 'brunelleschi' ) )  ) : ?>
		...
		<?php else : ?>
			<div class="entry-content">
				<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'brunelleschi' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>
...
<?php if ( count( get_the_category() ) ) : ?>
	...
	<?php else : ?>
			<div class="entry-content">
				<?php the_excerpt(); //the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'brunelleschi' ) ); ?>
