 		...
 		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<?php else : ?>
				...
				<div id="formLabels">
					...
					<p>
						<label for="author"><?php _e('Your Name', 'wpzoom') ?> <?php if ($req) ?><span><?php _e('*', 'wpzoom'); ?></span></label>
					...
					<p>
						<label for="email"><?php _e('Your Email', 'wpzoom') ?> <?php if ($req) ?> <span><?php _e('*', 'wpzoom'); ?></span></label>
					...
					<p>
						<label for="url"><?php _e('Website', 'wpzoom') ?><span><?php _e('', 'wpzoom'); ?></span></label>
